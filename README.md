...
<div style="display: flex; gap: 10px;">
  <img src="screenshots/home.png" alt="Screen Home" width="400"/>
  <img src="screenshots/apps.png" alt="Screen Apps" width="400"/>
</div>

## Português (PT-BR)

KOS é um sistema desenvolvido para um projeto caseiro de multimídia com **Rock Pi**. Ele combina um backend em **FastAPI** com uma interface web interativa, permitindo:
...
KOS is a system developed for a DIY multimedia project using the **Rock Pi**. It combines a **FastAPI** backend with an interactive web interface, allowing:
