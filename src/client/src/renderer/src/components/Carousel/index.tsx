...
export default function Carousel({ children, currentIndex, onChangeIndex }: CarouselProps) {
  ...
  }, [dragStartX, dragStartY, lockAxis, isDragging, currentIndex, slides.length])
